...
int main(int argc, char* argv[])
{
    ...
    eis.set_output_induced_subtree_differential(
...
void show_help(char* ename)
{
    ...
    std::cout << "  -h [ --help ]                 display help (this page) "
              << std::endl;
    std::cout << "  -f [ --file ] arg             file path" << std::endl;
    std::cout << "  -p [ --output_parenthesis ]   output the parenthesis of "
                 "the search tree" << std::endl;
    std::cout << "  -n [ --output_newick ]        output the newick format of "
                 "the search tree" << std::endl;
    std::cout << "  -b [ --output_both ]          output all induced subtrees "
                 "(entire and diff)" << std::endl;
    std::cout << "  -e [ --output_entire ]        output all induced subtrees "
                 "(entire)" << std::endl;
    std::cout << "  -d [ --output_differential ]  output all induced subtrees "
                 "(differential)" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << std::endl;
    std::cout << "Each line represents the adjacent list for a vertex v. "
              << std::endl;
